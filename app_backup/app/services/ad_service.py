...
<<<<<<< Updated upstream
    # ✅ CAMINHO CORRETO que funcionou no teste direto
=======
    # 🔒 CORRETO: criando diretamente em OU=DESENVOL
>>>>>>> Stashed changes
    dn = f"CN={nome_completo},OU=DESENVOL,DC=londrina,DC=pr,DC=gov,DC=br"
...
def desabilitar_usuario(login: str, desabilitar: bool = True, ip_address: str = None, user_agent: str = None, operator: str = "system") -> UsuarioOut:
    ...
    if desabilitar:
        ou_destino = "OU=Inativos,OU=DESENVOL,DC=londrina,DC=pr,DC=gov,DC=br"
    else:
        ou_destino = "OU=DESENVOL,DC=londrina,DC=pr,DC=gov,DC=br"
...
=======
# Funções restantes (atualizar_usuario, remover_usuario, trocar_senha, mover_usuario, desabilitar_usuario, autenticar_usuario, registrar_logout) permanecem iguais
>>>>>>> Stashed changes
